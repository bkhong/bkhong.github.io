...
export class CountdownSection extends React.Component {
		...
		return (
			<div className={css(styles.section)}>
				<div className={css(styles.textcontainer)}>
					<p className={css(styles.title1)}> Clash Royale League </p>
					<p className={css(styles.title2)}> NA/EU begins in </p>
				</div>
	...
	getSecondsRemaining() {
		...
		const deadline = 1533106800; //time of promotion end, in seconds
