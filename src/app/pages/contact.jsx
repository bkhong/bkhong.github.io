...
export class Contact extends React.Component {
    componentDidMount() {
        document.title = "Contact - Brandank";
        window.scrollTo(0, 0);
    }
    ...
    sendEmail() {
        ...
        if(parameters.from_name || parameters.reply_to || parameters.subject || parameters.message) {
            ...
            emailjs.send("default_service","brandonkhong", parameters)
                ...
                <Section title='Contact'>
                    ...
                    <div className={css(styles.wrapper)}>
                        <div className={css(styles.top)}>
                            <center>
                                <div className={css(styles.one)}>Organizational or coaching inquiries?</div>
                                <div className={css(styles.two)}>Get in touch by leaving me a message below, or by messaging me on <a href="https://twitter.com/brandank_cr">Twitter</a> or Discord to brandank#0825.</div>
                            </center>
                        </div>
